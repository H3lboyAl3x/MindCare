    ...
    <SafeAreaView style={stylesMobile.safeArea}>
      <KeyboardAvoidingView behavior="padding" style={stylesMobile.container}>
        <ScrollView contentContainerStyle={stylesMobile.inner} keyboardShouldPersistTaps="handled">
          ...
          <TextInput style={stylesMobile.textbox} value={nome} onChangeText={setNome} placeholder="Nome de usuário" placeholderTextColor="#6fcf87" />
          <TextInput style={stylesMobile.textbox} value={telefone} onChangeText={setTelefone} keyboardType="phone-pad" placeholder="Telefone" placeholderTextColor="#6fcf87" />
          <TextInput style={stylesMobile.textbox} value={email} onChangeText={setEmail} keyboardType="email-address" placeholder="Email" placeholderTextColor="#6fcf87" />
          <TextInput style={stylesMobile.textbox} value={password} onChangeText={setPassword} secureTextEntry placeholder="Senha" placeholderTextColor="#6fcf87" />
          <TextInput style={stylesMobile.textbox} value={confirmarp} onChangeText={setConfirmarp} secureTextEntry placeholder="Confirmar Senha" placeholderTextColor="#6fcf87" />
          <Text style={{ fontSize: 11, color: "red" }}>{espaco}</Text>
          <TouchableOpacity onPress={criar1}>
