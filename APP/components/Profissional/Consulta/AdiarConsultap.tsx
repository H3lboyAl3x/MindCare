...
export default function AdiarConsultap({ navigation, route }) {
    ...
    const Adiar = async () => {
        ...
        try {
            ...
            navigation.navigate("AnalisarConsultasp", { idConsulta: idConsulta, dataConsulta: formattedDate, horaConsulta: formattedTime, idpaci: idpaci, idp: idp, statusConsulta: statusConsulta });
        } catch (error) {
